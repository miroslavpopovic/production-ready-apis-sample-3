...
namespace BoardGamesApi.Tests.IntegrationTests
{
    public class GamesApiTests
    {
        ...
        {
            const string audience = "https://localhost:44337/";
            const string issuer = "https://localhost:44337/";
            const string key = "some-long-secret-key";

            var server = new TestServer(new WebHostBuilder()
                .UseStartup<Startup>().UseUrls("https://localhost:44337/")
                .UseSetting("Tokens:Audience", audience)
            ...
            _nonAdminToken = JwtTokenGenerator.Generate(
                "aspnetcore-api-demo", false, issuer, audience, key);
            _adminToken = JwtTokenGenerator.Generate(
                "aspnetcore-api-demo", true, issuer, audience, key);
        }
